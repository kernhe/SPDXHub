...
<div class="col-md-8 col-md-offset-2">
	...
	<div class="form-selection">
		...
		<button type="button" class="btn select-btn" id="package-btn" onclick="toggleDocView('none'), toggleFormView('block')">Package</button>
		<button type="button" class="btn select-btn" id="doc-btn" onclick="toggleFormView('none'), toggleDocView('block')">Document</button>	
	</div>
	
    <form class="form-menu" action="upload_action.php" method="POST" enctype="multipart/form-data">
