...
?>
    ...
    <div class="container">
		...
		<legend class="toggletext toggled"></legend>
  ...
  <tr>
          <td colspan="4"><label for="urigroup_yes"></label></td>
</tr>
<tr>
        <td colspan="4"><label for="uri-charset"><strong>Licences</strong></label></td>
          ...
          <tr>
                  ...
                  SPDX
                    <label title="Show an Outline of the document" for="uri-outline"> Approved</label>                  </td>
    ...
    <td colspan="2">
              ...
              Identifier       </div></td>
    <td width="118"><label for="uri-fbc" title="Use selected Character encoding only if missing in the document"> 
